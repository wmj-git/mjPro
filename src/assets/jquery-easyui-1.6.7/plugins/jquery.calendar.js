...
var _c=$(_a).find(".calendar-em_menu");
_c.find(".calendar-em_menu-year").unbind(".calendar").bind("keypress.calendar",function(e){
if(e.keyCode==13){
_d(true);
}
});
...
if(t.hasClass("calendar-em_menu-prev")||t.hasClass("calendar-prevyear")){
_f(-1);
}else{
if(t.hasClass("calendar-em_menu-month")){
...
function _d(_13){
var _14=$(_a).find(".calendar-em_menu");
var _15=_14.find(".calendar-em_menu-year").val();
...
_b.year+=_17;
_19(_a);
_c.find(".calendar-em_menu-year").val(_b.year);
};
function _10(_18){
_b.month+=_18;
if(_b.month>12){
...
$(_1a).find(".calendar-em_menu").show();
if($(_1a).find(".calendar-em_menu-month-inner").is(":empty")){
$(_1a).find(".calendar-em_menu-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_1a).find(".calendar-em_menu-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
var tr=$("<tr></tr>").appendTo(t);
for(var j=0;j<4;j++){
$("<td class=\"calendar-nav calendar-em_menu-month\"></td>").html(_1b.months[idx++]).attr("abbr",idx).appendTo(tr);
}
}
}
var _1c=$(_1a).find(".calendar-body");
var _1d=$(_1a).find(".calendar-em_menu");
var _1e=_1d.find(".calendar-em_menu-year-inner");
var _1f=_1d.find(".calendar-em_menu-month-inner");
...
_9(this);
_19(this);
$(this).find("div.calendar-em_menu").hide();
});
};
