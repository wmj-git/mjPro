...
_1($("body>div.em_menu:visible").not(".em_menu-inline"));
});
});
function _2(_3){
var _4=$.data(_3,"menu").options;
$(_3).addClass("em_menu-top");
...
_8.addClass("menu");
_9.push(_8);
if(!_8.hasClass("em_menu-content")){
...
if(!_e.hasClass("em_menu-content")){
_e.children("div").each(function(){
_f(_c,this);
});
$("<div class=\"em_menu-line\"></div>").prependTo(_e);
}
_10(_c,_e);
if(!_e.hasClass("em_menu-inline")){
_e.hide();
}
_11(_c,_e);
};
...
if(_15.separator){
_14.addClass("em_menu-sep");
}
if(!_14.hasClass("em_menu-sep")){
_14.addClass("em_menu-item");
_14.empty().append($("<div class=\"em_menu-text\"></div>").html(_15.text));
if(_15.iconCls){
$("<div class=\"em_menu-icon\"></div>").addClass(_15.iconCls).appendTo(_14);
}
if(_15.id){
_14.attr("id",_15.id);
}
...
if(_14[0].submenu){
$("<div class=\"em_menu-rightarrow\"></div>").appendTo(_14);
}
}
};
...
_18.find(".em_menu-item").each(function(){
$(this)._outerHeight(_19.itemHeight);
$(this).find(".em_menu-text").css({height:(_19.itemHeight-2)+"px",lineHeight:(_19.itemHeight-2)+"px"});
});
_18.removeClass("em_menu-noline").addClass(_19.noline?"em_menu-noline":"");
var _1c=_18.data("menu").options;
var _1d=_1c.width;
var _1e=_1c.height;
if(isNaN(parseInt(_1d))){
_1d=0;
_18.find("div.em_menu-text").each(function(){
...
_1e=_1f;
if(_18.hasClass("em_menu-top")&&_19.alignTo){
var at=$(_19.alignTo);
...
_18.children("div.em_menu-line")._outerHeight(_1f-2);
if(!_1b){
_18.hide();
}
};
...
var _2e=$(e.target).closest(".em_menu-item");
if(_2e.length){
...
_2e.addClass("em_menu-active");
if(_2e.hasClass("em_menu-item-disabled")){
_2e.addClass("em_menu-active-disabled");
return;
}
...
function _30(e){
var _31=$(e.target).closest(".em_menu-item");
if(_31.length){
_31.removeClass("em_menu-active em_menu-active-disabled");
var _32=_31[0].submenu;
if(_32){
if(e.pageX>=parseInt(_32.css("left"))){
_31.addClass("em_menu-active");
}else{
_1(_32);
}
}else{
_31.removeClass("em_menu-active");
}
}
};
function _33(e){
var _34=e.data.target;
var _35=$(e.target).closest(".em_menu-item");
if(_35.length){
...
_40.show(0,function(){
if(!_40[0].shadow){
_40[0].shadow=$("<div class=\"em_menu-shadow\"></div>").insertAfter(_40);
}
_40[0].shadow.css({display:(_40.hasClass("em_menu-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:_40.css("left"),top:_40.css("top"),width:_40.outerWidth(),height:_40.outerHeight()});
...
if(_44&&_44.length){
_45(_44);
_44.find("div.em_menu-item").each(function(){
if(this.submenu){
_1(this.submenu);
}
$(this).removeClass("menu-active");
...
function _4b(_4c){
_4c.children("div.em_menu-item").each(function(){
...
$("<div class=\"em_menu-rightarrow\"></div>").appendTo(_54.parent);
_b(_53,_57);
}
...
function _62(_63){
$(_63).children("div.em_menu-item").each(function(){
_58(_63,this);
});
if(_63.shadow){
_63.shadow.remove();
...
_68.text=_67.text;
$(_67.target).children("div.em_menu-text").html(_67.text);
});
},setIcon:function(jq,_69){
return jq.each(function(){
var _6a=$(_69.target).data("menuitem").options;
_6a.iconCls=_69.iconCls;
$(_69.target).children("div.em_menu-icon").remove();
if(_69.iconCls){
$("<div class=\"em_menu-icon\"></div>").addClass(_69.iconCls).appendTo(_69.target);
}
});
